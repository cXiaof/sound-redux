...
export const getIsActive = createSelector(getPlayingSongId, getId, (playingSongId, id) => playingSongId === id)

export const getSongComments = createSelector(getSong, (song) => (song && song.comments ? song.comments : []))
...
export const getSongs = createSelector(
    ...
    (playlist, playlists, entities) =>
        playlist in playlists ? denormalize(playlists[playlist].items.slice(1), [songSchema], entities) : []
)
